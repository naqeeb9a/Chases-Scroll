...
class FindPopupEventView extends HookWidget {
  static final EventRepository _eventRepository = EventRepository();
  bool isSaved = false;

  FindPopupEventView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    void refreshEventData() {
      myPopupLoading.value = false; // Set loading state back to true
