...
class SeeOtherUsersCommunitiesView extends HookWidget {
  ...
  final String? userId;
  const SeeOtherUsersCommunitiesView({required this.userId, super.key});
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: customText(
                                              text: comm.data!.imgSrc == null ||
                                                      comm.data!.imgSrc!.isEmpty
                                                  ? extractFirstLetters(
                                                      "${comm.data!.name}"
                                                          .toUpperCase())
                                                  : "",
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      customText(
                                          text:
                                              comm.data!.description.toString(),
                                          fontSize: 12,
