...
class OtherUsersMainProfileView extends HookWidget {
  ...
  const OtherUsersMainProfileView({this.userId, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    getMyEvents() {
      _eventRepository.getOtherUsersEvents(userID: userId ?? "0").then((value) {
    ...
    getAllCommunities() {
      _profileRepository
          .getOtherUsersJoinedCommunity(userID: userId)
          .then((value) {
    ...
    void getUsersProfile() {
      _profileRepository.getOtherUsersProfile(userID: userId).then((value) {
    ...
    void getUsersPost() {
      _profileRepository
          .getOtherUsersPosts(userID: userId, page: "0")
          .then((value) {
    ...
    connectFriend(String friendID) async {
      ...
      if (result['updated'] == true) {
        ToastResp.toastMsgCustom(
            resp: result['message'], color: Colors.orange.withOpacity(0.8));
        log(result.toString());
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: NetworkImage(
                      "${userProfileModel.value.data?.imgMain?.value}",
                    ),
                  ),
                ),
                child: Stack(
                  children: [
                    SizedBox(
                      height: height,
                      width: width,
                      child: userProfileModel.value.data?.imgMain?.value == null
                          ? const Image(image: AssetImage(AppImages.backBG))
                          : const Image(
                              image: AssetImage(AppImages.backBG),
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          String text =
                              "https://chasescroll-new.netlify.app/${userProfileModel.value.userId}";
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          // //                 : "",
                                          // //     hasBorder: true,
                                          // //     borderColor: userProfileModel
                                          // //                 .value.joinStatus ==
                                          // //             "NOT_CONNECTED"
                                          // //         ? AppColors.primary
                                          // //         : AppColors.white,
                                          // //     textColor: userProfileModel
                                          // //                 .value.joinStatus ==
                                          // //             "FRIEND_REQUEST_SENT"
                                          // //         ? AppColors.btnOrange
                                          // //         : AppColors.primary,
                                          ...
                                          // //               .value.joinStatus !=
                                          // //           "FRIEND_REQUEST_SENT") {
                                          // //         connectFriend(userProfileModel
                                          // //             .value.userId!);
                                          // //       } else {
                                          // //         disconnectFriend(
                                          // //             userProfileModel
                                                                      ...
                                                                      children: [
                                                                        GestureDetector(
                                                                          onTap:
                                                                              () async {
                                                                            final result =
                                                                                await _exploreRepository.disconnectWithFriend(friendID: content.userId);
                                                                            if (result['updated'] ==
                                                                                true) {
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: content.joinStatus == "CONNECTED" ? AppColors.red : AppColors.white,
                                                                              borderRadius: BorderRadius.circular(10),
                                                                            ),
                                                                            child:
                                                                                Center(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () => context.push(
                                            AppRoutes.otherUsersProfileEvents,
                                            extra: userId),
                                        child: customText(
                                          text: "See all",
                                          fontSize: 14,
