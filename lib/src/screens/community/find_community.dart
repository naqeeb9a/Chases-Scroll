...
class FindCommunity extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    joinCommunity(String groupId) {
      ...
      final keys = locator<LocalStorageService>()
          .getDataFromDisk(AppKeys.userId.toString());
      log(keys.toString());

      _communityRepo
          .joinCommunity(groupId: groupId, userId: keys)
          .then((value) {
        if (value) {
