...
class Content {
  ...
  Content.fromJson(Map<String, dynamic> json) {
    ...
    if (json['mulitpleMedia'] != null) {
      mulitpleMedia = <String>[];
      json['mulitpleMedia'].forEach((v) {
        mulitpleMedia!.add(v);
      });
    }
    mediaType = json['mediaType'];
    edited = json['edited'];
    readList = json['readList'].cast<String>();
    if (json['reactList'] != null) {
      reactList = <String>[];
      json['reactList'].forEach((v) {
        reactList!.add(v);
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['media'] = media;
    data['chatID'] = chatID;
    data['mulitpleMedia'] = mulitpleMedia;
    data['mediaType'] = mediaType;
    data['edited'] = edited;
    data['readList'] = readList;
    if (reactList != null) {
      data['reactList'] = reactList!.map((v) => v).toList();
    }
