...
const PAD_ASYM_H15_V35 = EdgeInsets.symmetric(horizontal: 15.0, vertical: 35.0);
...
const PAD_SYM_H10_V10 = EdgeInsets.symmetric(horizontal: 10, vertical: 10);
const PAD_SYM_H16 = EdgeInsets.symmetric(horizontal: 16);

const PAD_SYM_H20 = EdgeInsets.symmetric(horizontal: 20);
const PAD_SYM_H20_V0 = EdgeInsets.symmetric(horizontal: 20, vertical: 0);
const PAD_SYM_H20_V10 = EdgeInsets.symmetric(horizontal: 20, vertical: 10);
const PAD_SYM_H20_V20 = EdgeInsets.symmetric(horizontal: 20, vertical: 20);
const PAD_SYM_H20_V30 = EdgeInsets.symmetric(horizontal: 20, vertical: 30);
const PAD_SYM_H20_V5 = EdgeInsets.symmetric(horizontal: 20, vertical: 5);
