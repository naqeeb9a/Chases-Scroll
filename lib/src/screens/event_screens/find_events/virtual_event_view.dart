...
class FindVirtualEvents extends HookWidget {
  static final EventRepository _eventRepository = EventRepository();
  bool isSaved = false;

  FindVirtualEvents({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    void refreshEventData() {
      myVirtualLoading.value = false; // Set loading state back to true
