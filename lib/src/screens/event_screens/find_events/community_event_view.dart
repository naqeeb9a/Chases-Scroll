...
class FindCommunityEventView extends HookWidget {
  static final EventRepository _eventRepository = EventRepository();
  bool isSaved = false;

  FindCommunityEventView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    void refreshEventData() {
      myCommunityLoading.value = false; // Set loading state back to true
    ...
    return Column(
      children: [
        myCommunitylModel.value.isEmpty
            ? SizedBox(
                height: 50.h,
