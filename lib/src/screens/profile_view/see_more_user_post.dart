...
class SeeMoreUserPost extends HookWidget {
  ...
  final String? userID;
  const SeeMoreUserPost({required this.userID, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    getPost() {
      _profileRepository.getAllUserPosts(page: "0").then((value) {
